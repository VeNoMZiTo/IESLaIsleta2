            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Documento">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.documento.fields.nombre') }}
                        </th>
                        <th>
                            {{ trans('cruds.documento.fields.archivo') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($documentos as $key => $documento)
                        <tr data-entry-id="{{ $documento->id }}">
                            ...
                            <td>
                                @foreach($documento->archivo as $key => $media)
...
@endcan
  ...
  $('.datatable-Documento:not(.ajaxTable)').DataTable({ buttons: dtButtons })
