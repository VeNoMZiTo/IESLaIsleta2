...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.informacion.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.informacions.update", [$informacion->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="subtitulo">{{ trans('cruds.informacion.fields.subtitulo') }}</label>
                <textarea class="form-control {{ $errors->has('subtitulo') ? 'is-invalid' : '' }}" name="subtitulo" id="subtitulo">{{ old('subtitulo', $informacion->subtitulo) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('texto') ? 'is-invalid' : '' }}" name="texto" id="texto">{!! old('texto', $informacion->texto) !!}</textarea>
                @if($errors->has('texto'))
