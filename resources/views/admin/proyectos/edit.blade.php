    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.proyectos.update", [$proyecto->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('titulo') ? 'is-invalid' : '' }}" type="text" name="titulo" id="titulo" value="{{ old('titulo', $proyecto->titulo) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('texto') ? 'is-invalid' : '' }}" name="texto" id="texto">{!! old('texto', $proyecto->texto) !!}</textarea>
                @if($errors->has('texto'))
