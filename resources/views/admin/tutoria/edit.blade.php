...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tutoria.update", [$tutorium->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nivel">{{ trans('cruds.tutorium.fields.nivel') }}</label>
                <input class="form-control {{ $errors->has('nivel') ? 'is-invalid' : '' }}" type="text" name="nivel" id="nivel" value="{{ old('nivel', $tutorium->nivel) }}" required>
                @if($errors->has('nivel'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('grupo') ? 'is-invalid' : '' }}" type="text" name="grupo" id="grupo" value="{{ old('grupo', $tutorium->grupo) }}" required>
                @if($errors->has('grupo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tutor') ? 'is-invalid' : '' }}" type="text" name="tutor" id="tutor" value="{{ old('tutor', $tutorium->tutor) }}" required>
                @if($errors->has('tutor'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('abreviatura_departamento') ? 'is-invalid' : '' }}" type="text" name="abreviatura_departamento" id="abreviatura_departamento" value="{{ old('abreviatura_departamento', $tutorium->abreviatura_departamento) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $tutorium->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hora_atencion') ? 'is-invalid' : '' }}" type="text" name="hora_atencion" id="hora_atencion" value="{{ old('hora_atencion', $tutorium->hora_atencion) }}" required>
