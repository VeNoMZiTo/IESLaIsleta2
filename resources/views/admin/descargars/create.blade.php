...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.descargar.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.descargars.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group {{ $errors->has('docente') ? 'has-error' : '' }}">
                <label for="docente">{{ trans('cruds.descargar.fields.docente') }}</label>
                <div class="needsclick dropzone" id="docente-dropzone">
                ...
                <p class="helper-block">
                    {{ trans('cruds.descargar.fields.docente_helper') }}
                </p>
            </div>
            <div class="form-group {{ $errors->has('directiva') ? 'has-error' : '' }}">
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.descargar.fields.directiva_helper') }}
                </p>
            </div>
            <div class="form-group {{ $errors->has('tutoria') ? 'has-error' : '' }}">
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.descargar.fields.tutoria_helper') }}
                </p>
            </div>
            <div>
