        ...
        <div class='container g-py-100'>
            <div class='row text-center g-mb-30'>
                <div class="text-center col-12">
                    <h2 class="h1 g-color-black mb-4">Junta de Delegados</h2>
                    <div class="d-inline-block g-width-70 g-height-2 g-bg-primary mb-4"></div>
                </div>
                <p class="lead g-px-200--lg g-color-gray-dark-v3">
                    La Junta de delegad@s y subdelegad@s de centro es el <b>órgano de participación democrática</b> del alumnado por excelencia y por ley, después de la asamblea de clase.
                </p>
            </div>
            <div class="row">
...
{{--                                    <i class="icon-education-133 u-line-icon-pro g-color-primary align-self-center g-mr-10 g-font-size-18"></i>--}}
                ...
                <div class="col-lg-6">
                    <img class="img-fluid u-shadow-v1-5 rounded" src="/img/junta-delegados/1.jpg" alt="IES La Isleta Centro">
                </div>
            </div>
        </div>
    </section>
