@extends('master')
@section('title','Documentos de familias')
@section('css')
@endsection
@section('content')
        ...
        <div class='container g-py-100'>
            <div class='row text-center g-mb-30'>
                <div class="text-center col-12">
                    <h2 class="h1 g-color-black mb-4">Documentos para familias</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <header class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
                        <h2 class="h3 u-heading-v2__title">Descargar documentos para familias</h2>
                    </header>
                    <p class="lead g-mb-15">
                        Cualquier duda o sugerencia puede contactar con <a href="/consultas">nosotros</a>.
                    </p>
                    <div class="row">
                        @foreach($documentosFamilia as $d)
                            <div class='col-md-6 g-mb-30'>
                                <a class='media g-mb-15 cartaDescarga' href='{{$d->archivo->getUrl()}}' download>
                                    <div class='d-flex align-self-center mr-3'>
                                        @php
                                            $tipo = explode('.',$d->archivo->file_name);
