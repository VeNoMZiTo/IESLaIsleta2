	...
	Calendar.prototype = {
		...
		_renderBody: function() {
			...
			for(var m = 0; m < 12; m++) {
				...
				table.addClass('month').attr('data-mes',dates[this.options.language].monthsShort[m]);
				...
				while(currentDate <= lastDate)
				{
					...
					do
					{
						...
						if(currentDate < firstDate) {
							...
							cellContent.addClass('day-content').attr('data-dia',currentDate.getDate());
		...
		_applyEvents: function () {
			...
			setInterval(function() {
				...
				if(monthSize * 6 < calendarSize) {
					monthContainerClass += ' col-calendario';
				}
